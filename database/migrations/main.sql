...
ALTER TABLE posts ADD COLUMN IF NOT EXISTS folder VARCHAR(150) NULL ;
...
ALTER TABLE posts ADD COLUMN IF NOT EXISTS user_id INT NOT NULL;
ALTER TABLE posts DROP CONSTRAINT IF EXISTS user_id;
