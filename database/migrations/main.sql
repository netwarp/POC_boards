...
ALTER TABLE users ADD COLUMN IF NOT EXISTS name VARCHAR(50) UNIQUE;
...
ALTER TABLE boards ADD COLUMN IF NOT EXISTS user_id INT NOT NULL;
ALTER TABLE boards DROP CONSTRAINT IF EXISTS user_id;
ALTER TABLE boards ADD CONSTRAINT user_id FOREIGN KEY (user_id) REFERENCES users (id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE threads ADD COLUMN IF NOT EXISTS user_id INT NOT NULL;
ALTER TABLE threads DROP CONSTRAINT IF EXISTS user_id;
ALTER TABLE threads ADD CONSTRAINT user_id FOREIGN KEY (user_id) REFERENCES users (id) ON UPDATE CASCADE ON DELETE CASCADE;
